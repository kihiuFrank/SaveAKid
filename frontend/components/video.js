    ...
    <Container>
      <div className="w-full max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl ">
        <div
          ...
          className="relative z-10 bg-indigo-300 cursor-pointer aspect-w-16 aspect-h-9 bg-gradient-to-tr from-purple-400 to-indigo-700"
        >
          {!playVideo && (
        ...
        <p>Credits: Beast Philanthropy </p>
      </div>
    </Container>
  );
};
